<template>
    <div class="richform-demo">
        {{ values }}
        <br />
        <ElButton type="info" size="default" @click="onSetValues">赋值values</ElButton>
        <!-- todo -->
        <ElButton type="primary" size="default" @click="changeTheme">改变主题</ElButton>
        <ElButton type="success" size="default" @click="hooks.validate()">外部校验</ElButton>
        <ElButton type="danger" size="default" @click="onHidden">触发隐藏</ElButton>
        <Richform :form="form" :schema="schema" :values="values" :hooks="hooks" :isDesign="false" />
    </div>
</template>
...
export default {
            ...
            form: {
                ...
                actions: [
                    //声明显示在下方和动作按钮
                    {
                        ...
                        size: "default" // 'large'| 'default'| 'small', 若未指明，则等同于form.size
                    },
                    {
                                        ...
                                        actions: [
                                            {
                                                ...
                                                size: "default", // "default", "small", "large" 若未指明，则等同于form.size
                                                loading: false,
                                            },
                                        ],
                                        fields: [
    ...
    methods: {
        ...
        onSetValues() {
            ...
            this.values.selectA = "选项2";
        },
        onHidden() {
            this.values.radioA = "radioB";
        },
        changeTheme() {
            this.form.colors = {
                theme: "#121B2C",
